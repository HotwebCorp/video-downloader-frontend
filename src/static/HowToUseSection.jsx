...
function HowToUseSection() {
    ...
    return (
        <div className="flex flex-col p-2 h-10/12">
            <h2 className="font-bold text-lg text-center lg:text-4xl  ">How To Use</h2>
            <h3 className="text-center mb-4 text-3xl lg:text-5xl font-extrabold bg-gradient-to-r from-blue-950 to-blue-400 bg-clip-text text-transparent">Video Downloader</h3>
